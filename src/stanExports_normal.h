...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(18, 17, "end", "/include/prior_select.stan");
    reader.add_event(18, 2, "restart", "model_normal");
    reader.add_event(18, 2, "include", "/include/count_nonzero.stan");
    reader.add_event(18, 0, "start", "/include/count_nonzero.stan");
    reader.add_event(30, 12, "end", "/include/count_nonzero.stan");
    reader.add_event(30, 3, "restart", "model_normal");
    reader.add_event(32, 5, "include", "/include/data_common.stan");
    reader.add_event(32, 0, "start", "/include/data_common.stan");
    reader.add_event(101, 69, "end", "/include/data_common.stan");
    reader.add_event(101, 6, "restart", "model_normal");
    reader.add_event(114, 19, "include", "/include/transformed_data_common.stan");
    reader.add_event(114, 0, "start", "/include/transformed_data_common.stan");
    reader.add_event(181, 67, "end", "/include/transformed_data_common.stan");
    reader.add_event(181, 20, "restart", "model_normal");
    reader.add_event(183, 22, "include", "/include/parameters_common.stan");
    reader.add_event(183, 0, "start", "/include/parameters_common.stan");
    reader.add_event(190, 7, "end", "/include/parameters_common.stan");
    reader.add_event(190, 23, "restart", "model_normal");
    reader.add_event(193, 26, "include", "/include/transformed_parameters_common.stan");
    reader.add_event(193, 0, "start", "/include/transformed_parameters_common.stan");
    reader.add_event(295, 102, "end", "/include/transformed_parameters_common.stan");
    reader.add_event(295, 27, "restart", "model_normal");
    reader.add_event(380, 112, "include", "/include/model_common.stan");
    reader.add_event(380, 0, "start", "/include/model_common.stan");
    reader.add_event(418, 38, "end", "/include/model_common.stan");
    reader.add_event(418, 113, "restart", "model_normal");
    reader.add_event(430, 125, "include", "/include/generated_quantities_common.stan");
    reader.add_event(430, 0, "start", "/include/generated_quantities_common.stan");
    reader.add_event(494, 64, "end", "/include/generated_quantities_common.stan");
    reader.add_event(494, 126, "restart", "model_normal");
    reader.add_event(516, 146, "end", "model_normal");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("offset", "(has_offset ? (ni_ipd + (nint * (ni_agd_arm + ni_agd_contrast))) : 0 )", (has_offset ? (ni_ipd + (nint * (ni_agd_arm + ni_agd_contrast))) : 0 ));
            context__.validate_dims("data initialization", "offset", "vector_d", context__.to_vec((has_offset ? (ni_ipd + (nint * (ni_agd_arm + ni_agd_contrast))) : 0 )));
            offset = Eigen::Matrix<double, Eigen::Dynamic, 1>((has_offset ? (ni_ipd + (nint * (ni_agd_arm + ni_agd_contrast))) : 0 ));
            vals_r__ = context__.vals_r("offset");
            pos__ = 0;
            size_t offset_j_1_max__ = (has_offset ? (ni_ipd + (nint * (ni_agd_arm + ni_agd_contrast))) : 0 );
            ...
            check_greater_or_equal(function__, "prior_intercept_dist", prior_intercept_dist, 1);
            ...
            check_greater_or_equal(function__, "prior_trt_dist", prior_trt_dist, 1);
            ...
            check_greater_or_equal(function__, "prior_het_dist", prior_het_dist, 1);
            ...
            check_greater_or_equal(function__, "prior_reg_dist", prior_reg_dist, 1);
            ...
            check_greater_or_equal(function__, "prior_aux_dist", prior_aux_dist, 1);
            ...
            validate_non_negative_index("ipd_y", "ni_ipd", ni_ipd);
            context__.validate_dims("data initialization", "ipd_y", "double", context__.to_vec(ni_ipd));
            ipd_y = std::vector<double>(ni_ipd, double(0));
            vals_r__ = context__.vals_r("ipd_y");
            pos__ = 0;
            size_t ipd_y_k_0_max__ = ni_ipd;
            for (size_t k_0__ = 0; k_0__ < ipd_y_k_0_max__; ++k_0__) {
                ipd_y[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 111;
            validate_non_negative_index("agd_arm_y", "ni_agd_arm", ni_agd_arm);
            context__.validate_dims("data initialization", "agd_arm_y", "double", context__.to_vec(ni_agd_arm));
            agd_arm_y = std::vector<double>(ni_agd_arm, double(0));
            vals_r__ = context__.vals_r("agd_arm_y");
            pos__ = 0;
            size_t agd_arm_y_k_0_max__ = ni_agd_arm;
            for (size_t k_0__ = 0; k_0__ < agd_arm_y_k_0_max__; ++k_0__) {
                agd_arm_y[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 112;
            validate_non_negative_index("agd_arm_se", "ni_agd_arm", ni_agd_arm);
            context__.validate_dims("data initialization", "agd_arm_se", "double", context__.to_vec(ni_agd_arm));
            agd_arm_se = std::vector<double>(ni_agd_arm, double(0));
            vals_r__ = context__.vals_r("agd_arm_se");
            pos__ = 0;
            size_t agd_arm_se_k_0_max__ = ni_agd_arm;
            for (size_t k_0__ = 0; k_0__ < agd_arm_se_k_0_max__; ++k_0__) {
                agd_arm_se[k_0__] = vals_r__[pos__++];
            }
            size_t agd_arm_se_i_0_max__ = ni_agd_arm;
            for (size_t i_0__ = 0; i_0__ < agd_arm_se_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "agd_arm_se[i_0__]", agd_arm_se[i_0__], 0);
            }
            ...
            stan::math::assign(offset_ipd,((primitive_value(has_offset) && primitive_value(ni_ipd)) ? stan::math::promote_scalar<double>(stan::model::rvalue(offset, stan::model::cons_list(stan::model::index_min_max(1, ni_ipd), stan::model::nil_index_list()), "offset")) : stan::math::promote_scalar<double>(odummy) ));
            ...
            stan::math::assign(offset_agd_arm,((primitive_value(has_offset) && primitive_value(ni_agd_arm)) ? stan::math::promote_scalar<double>(stan::model::rvalue(offset, stan::model::cons_list(stan::model::index_min_max((ni_ipd + 1), (ni_ipd + (nint * ni_agd_arm))), stan::model::nil_index_list()), "offset")) : stan::math::promote_scalar<double>(odummy) ));
            ...
            stan::math::assign(offset_agd_contrast,((primitive_value(has_offset) && primitive_value(ni_agd_contrast)) ? stan::math::promote_scalar<double>(stan::model::rvalue(offset, stan::model::cons_list(stan::model::index_min_max(((ni_ipd + (nint * ni_agd_arm)) + 1), (ni_ipd + (nint * (ni_agd_arm + ni_agd_contrast)))), stan::model::nil_index_list()), "offset")) : stan::math::promote_scalar<double>(odummy) ));
            ...
            validate_non_negative_index("sigma", "narm_ipd", narm_ipd);
            num_params_r__ += narm_ipd;
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("sigma", "narm_ipd", narm_ipd);
        context__.validate_dims("parameter initialization", "sigma", "vector_d", context__.to_vec(narm_ipd));
        Eigen::Matrix<double, Eigen::Dynamic, 1> sigma(narm_ipd);
        size_t sigma_j_1_max__ = narm_ipd;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                sigma = in__.vector_lb_constrain(0, narm_ipd, lp__);
            else
                sigma = in__.vector_lb_constrain(0, narm_ipd);
            ...
            if (as_bool(logical_eq(link, 1))) {
                ...
                stan::math::assign(theta_ipd, eta_ipd);
            } else if (as_bool(logical_eq(link, 2))) {
                current_statement_begin__ = 301;
                stan::math::assign(theta_ipd, stan::math::exp(eta_ipd));
            }
                ...
                if (as_bool(logical_gt(nint, 1))) {
                    ...
                    if (as_bool(RE)) {
                        ...
                        if (as_bool(logical_eq(link, 1))) {
                            ...
                            for (int i = 1; i <= ni_agd_arm; ++i) {
                                ...
                                if (as_bool(get_base1(which_RE, (narm_ipd + i), "which_RE", 1))) {
                                    ...
                                    stan::model::assign(theta_agd_arm_ii, 
                                                stan::model::cons_list(stan::model::index_min_max((1 + ((i - 1) * nint)), (i * nint)), stan::model::nil_index_list()), 
                                                add(stan::model::rvalue(eta_agd_arm_noRE, stan::model::cons_list(stan::model::index_min_max((1 + ((i - 1) * nint)), (i * nint)), stan::model::nil_index_list()), "eta_agd_arm_noRE"), get_base1(f_delta, get_base1(which_RE, (narm_ipd + i), "which_RE", 1), "f_delta", 1)), 
                                                "assigning variable theta_agd_arm_ii");
                                } else {
                                    current_statement_begin__ = 316;
                                    stan::model::assign(theta_agd_arm_ii, 
                                                stan::model::cons_list(stan::model::index_min_max((1 + ((i - 1) * nint)), (i * nint)), stan::model::nil_index_list()), 
                                                stan::model::rvalue(eta_agd_arm_noRE, stan::model::cons_list(stan::model::index_min_max((1 + ((i - 1) * nint)), (i * nint)), stan::model::nil_index_list()), "eta_agd_arm_noRE"), 
                                                "assigning variable theta_agd_arm_ii");
                                }
                            }
                        } else if (as_bool(logical_eq(link, 2))) {
                            ...
                            for (int i = 1; i <= ni_agd_arm; ++i) {
                                ...
                                if (as_bool(get_base1(which_RE, (narm_ipd + i), "which_RE", 1))) {
                                    ...
                                    stan::model::assign(theta_agd_arm_ii, 
                                                stan::model::cons_list(stan::model::index_min_max((1 + ((i - 1) * nint)), (i * nint)), stan::model::nil_index_list()), 
                                                stan::math::exp(add(stan::model::rvalue(eta_agd_arm_noRE, stan::model::cons_list(stan::model::index_min_max((1 + ((i - 1) * nint)), (i * nint)), stan::model::nil_index_list()), "eta_agd_arm_noRE"), get_base1(f_delta, get_base1(which_RE, (narm_ipd + i), "which_RE", 1), "f_delta", 1))), 
                                                "assigning variable theta_agd_arm_ii");
                                } else {
                                    current_statement_begin__ = 323;
                                    stan::model::assign(theta_agd_arm_ii, 
                                                stan::model::cons_list(stan::model::index_min_max((1 + ((i - 1) * nint)), (i * nint)), stan::model::nil_index_list()), 
                                                stan::math::exp(stan::model::rvalue(eta_agd_arm_noRE, stan::model::cons_list(stan::model::index_min_max((1 + ((i - 1) * nint)), (i * nint)), stan::model::nil_index_list()), "eta_agd_arm_noRE")), 
                                                "assigning variable theta_agd_arm_ii");
                                }
                            }
                        }
                        ...
                        if (as_bool(logical_eq(link, 1))) {
                            ...
                            stan::math::assign(theta_agd_arm_ii, (has_offset ? stan::math::promote_scalar<local_scalar_t__>(add(multiply(X_agd_arm, beta_tilde), offset_agd_arm)) : stan::math::promote_scalar<local_scalar_t__>(multiply(X_agd_arm, beta_tilde)) ));
                        } else if (as_bool(logical_eq(link, 2))) {
                            current_statement_begin__ = 337;
                            stan::math::assign(theta_agd_arm_ii, (has_offset ? stan::math::promote_scalar<local_scalar_t__>(stan::math::exp(add(multiply(X_agd_arm, beta_tilde), offset_agd_arm))) : stan::math::promote_scalar<local_scalar_t__>(stan::math::exp(multiply(X_agd_arm, beta_tilde))) ));
                        }
                    ...
                    if (as_bool(RE)) {
                        ...
                        if (as_bool(logical_eq(link, 1))) {
                            ...
                            for (int i = 1; i <= ni_agd_arm; ++i) {
                                ...
                                if (as_bool(get_base1(which_RE, (narm_ipd + i), "which_RE", 1))) {
                                    ...
                                    stan::model::assign(theta_agd_arm_bar, 
                                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                                (get_base1(eta_agd_arm_noRE, i, "eta_agd_arm_noRE", 1) + get_base1(f_delta, get_base1(which_RE, (narm_ipd + i), "which_RE", 1), "f_delta", 1)), 
                                                "assigning variable theta_agd_arm_bar");
                                } else {
                                    current_statement_begin__ = 357;
                                    stan::model::assign(theta_agd_arm_bar, 
                                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                                get_base1(eta_agd_arm_noRE, i, "eta_agd_arm_noRE", 1), 
                                                "assigning variable theta_agd_arm_bar");
                                }
                            }
                        } else if (as_bool(logical_eq(link, 2))) {
                            ...
                            for (int i = 1; i <= ni_agd_arm; ++i) {
                                ...
                                if (as_bool(get_base1(which_RE, (narm_ipd + i), "which_RE", 1))) {
                                    ...
                                    stan::model::assign(theta_agd_arm_bar, 
                                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                                stan::math::exp((get_base1(eta_agd_arm_noRE, i, "eta_agd_arm_noRE", 1) + get_base1(f_delta, get_base1(which_RE, (narm_ipd + i), "which_RE", 1), "f_delta", 1))), 
                                                "assigning variable theta_agd_arm_bar");
                                } else {
                                    current_statement_begin__ = 364;
                                    stan::model::assign(theta_agd_arm_bar, 
                                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                                stan::math::exp(get_base1(eta_agd_arm_noRE, i, "eta_agd_arm_noRE", 1)), 
                                                "assigning variable theta_agd_arm_bar");
                                }
                            }
                        }
                        ...
                        if (as_bool(logical_eq(link, 1))) {
                            ...
                            stan::math::assign(theta_agd_arm_bar, (has_offset ? stan::math::promote_scalar<local_scalar_t__>(add(multiply(X_agd_arm, beta_tilde), offset_agd_arm)) : stan::math::promote_scalar<local_scalar_t__>(multiply(X_agd_arm, beta_tilde)) ));
                        } else if (as_bool(logical_eq(link, 2))) {
                            current_statement_begin__ = 373;
                            stan::math::assign(theta_agd_arm_bar, (has_offset ? stan::math::promote_scalar<local_scalar_t__>(stan::math::exp(add(multiply(X_agd_arm, beta_tilde), offset_agd_arm))) : stan::math::promote_scalar<local_scalar_t__>(stan::math::exp(multiply(X_agd_arm, beta_tilde))) ));
                        }
                    }
                }
            }
            ...
            prior_select_lp(sigma, prior_aux_dist, prior_aux_location, prior_aux_scale, prior_aux_df, lp__, lp_accum__, pstream__);
            current_statement_begin__ = 425;
            lp_accum__.add(normal_log<propto__>(ipd_y, theta_ipd, stan::model::rvalue(sigma, stan::model::cons_list(stan::model::index_multi(ipd_arm), stan::model::nil_index_list()), "sigma")));
            current_statement_begin__ = 428;
            lp_accum__.add(normal_log<propto__>(agd_arm_y, theta_agd_arm_bar, agd_arm_se));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("theta_bar_cum");
    ...
    void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
        ...
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(((ni_ipd + ni_agd_arm) + ni_agd_contrast));
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(((ni_agd_arm + ni_agd_contrast) * n_int_thin));
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(n_delta);
        dimss__.push_back(dims__);
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> sigma = in__.vector_lb_constrain(0, narm_ipd);
        size_t sigma_j_1_max__ = narm_ipd;
        for (size_t j_1__ = 0; j_1__ < sigma_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            validate_non_negative_index("fitted", "((ni_ipd + ni_agd_arm) + ni_agd_contrast)", ((ni_ipd + ni_agd_arm) + ni_agd_contrast));
            Eigen::Matrix<double, Eigen::Dynamic, 1> fitted(((ni_ipd + ni_agd_arm) + ni_agd_contrast));
            stan::math::initialize(fitted, DUMMY_VAR__);
            stan::math::fill(fitted, DUMMY_VAR__);
            current_statement_begin__ = 439;
            validate_non_negative_index("theta_bar_cum", "((ni_agd_arm + ni_agd_contrast) * n_int_thin)", ((ni_agd_arm + ni_agd_contrast) * n_int_thin));
            Eigen::Matrix<double, Eigen::Dynamic, 1> theta_bar_cum(((ni_agd_arm + ni_agd_contrast) * n_int_thin));
            stan::math::initialize(theta_bar_cum, DUMMY_VAR__);
            stan::math::fill(theta_bar_cum, DUMMY_VAR__);
            ...
            for (int i = 1; i <= ni_agd_arm; ++i) {
                ...
                for (int j = 1; j <= n_int_thin; ++j) {
                    ...
                    stan::model::assign(theta_bar_cum, 
                                ...
                                "assigning variable theta_bar_cum");
                }
            }
            ...
            for (int i = 1; i <= ni_agd_contrast; ++i) {
                ...
                for (int j = 1; j <= n_int_thin; ++j) {
                    ...
                    stan::model::assign(theta_bar_cum, 
                                stan::model::cons_list(stan::model::index_uni(((ni_agd_arm + ((i - 1) * n_int_thin)) + j)), stan::model::nil_index_list()), 
                ...
                stan::model::assign(fitted, 
                            stan::model::cons_list(stan::model::index_uni(((ni_ipd + ni_agd_arm) + i)), stan::model::nil_index_list()), 
                            get_base1(eta_agd_contrast_bar, i, "eta_agd_contrast_bar", 1), 
            ...
            for (int i = 1; i <= ni_ipd; ++i) {
                ...
                stan::model::assign(log_lik, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            normal_log(get_base1(ipd_y, i, "ipd_y", 1), get_base1(theta_ipd, i, "theta_ipd", 1), get_base1(sigma, get_base1(ipd_arm, i, "ipd_arm", 1), "sigma", 1)), 
                            "assigning variable log_lik");
                ...
                stan::model::assign(resdev, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (pow((get_base1(ipd_y, i, "ipd_y", 1) - get_base1(fitted, i, "fitted", 1)), 2) / pow(get_base1(sigma, get_base1(ipd_arm, i, "ipd_arm", 1), "sigma", 1), 2)), 
                            "assigning variable resdev");
            }
            ...
            for (int i = 1; i <= ni_agd_arm; ++i) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            normal_log(get_base1(agd_arm_y, i, "agd_arm_y", 1), get_base1(theta_agd_arm_bar, i, "theta_agd_arm_bar", 1), get_base1(agd_arm_se, i, "agd_arm_se", 1)), 
                            "assigning variable log_lik");
                current_statement_begin__ = 506;
                stan::model::assign(fitted, 
                            stan::model::cons_list(stan::model::index_uni((ni_ipd + i)), stan::model::nil_index_list()), 
                            get_base1(theta_agd_arm_bar, i, "theta_agd_arm_bar", 1), 
                            "assigning variable fitted");
                current_statement_begin__ = 507;
                stan::model::assign(resdev, 
                            stan::model::cons_list(stan::model::index_uni((ni_ipd + i)), stan::model::nil_index_list()), 
                            (pow((get_base1(agd_arm_y, i, "agd_arm_y", 1) - get_base1(fitted, (ni_ipd + i), "fitted", 1)), 2) / pow(get_base1(agd_arm_se, i, "agd_arm_se", 1), 2)), 
                            "assigning variable resdev");
            ...
            current_statement_begin__ = 436;
            size_t fitted_j_1_max__ = ((ni_ipd + ni_agd_arm) + ni_agd_contrast);
            for (size_t j_1__ = 0; j_1__ < fitted_j_1_max__; ++j_1__) {
                vars__.push_back(fitted(j_1__));
            }
            current_statement_begin__ = 439;
            size_t theta_bar_cum_j_1_max__ = ((ni_agd_arm + ni_agd_contrast) * n_int_thin);
            for (size_t j_1__ = 0; j_1__ < theta_bar_cum_j_1_max__; ++j_1__) {
                vars__.push_back(theta_bar_cum(j_1__));
            }
            current_statement_begin__ = 443;
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < theta_bar_cum_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "theta_bar_cum" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t delta_j_1_max__ = n_delta;
        for (size_t j_1__ = 0; j_1__ < delta_j_1_max__; ++j_1__) {
