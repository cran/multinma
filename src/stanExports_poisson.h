...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(103, 6, "restart", "model_poisson");
    reader.add_event(111, 14, "include", "/include/transformed_data_common.stan");
    reader.add_event(111, 0, "start", "/include/transformed_data_common.stan");
    reader.add_event(178, 67, "end", "/include/transformed_data_common.stan");
    reader.add_event(178, 15, "restart", "model_poisson");
    reader.add_event(180, 17, "include", "/include/parameters_common.stan");
    reader.add_event(180, 0, "start", "/include/parameters_common.stan");
    reader.add_event(187, 7, "end", "/include/parameters_common.stan");
    reader.add_event(187, 18, "restart", "model_poisson");
    reader.add_event(192, 23, "include", "/include/transformed_parameters_theta.stan");
    reader.add_event(192, 0, "start", "/include/transformed_parameters_theta.stan");
    reader.add_event(197, 5, "end", "/include/transformed_parameters_theta.stan");
    reader.add_event(197, 24, "restart", "model_poisson");
    reader.add_event(197, 24, "include", "/include/transformed_parameters_common.stan");
    reader.add_event(197, 0, "start", "/include/transformed_parameters_common.stan");
    reader.add_event(299, 102, "end", "/include/transformed_parameters_common.stan");
    reader.add_event(299, 25, "restart", "model_poisson");
    reader.add_event(364, 90, "include", "/include/model_common.stan");
    reader.add_event(364, 0, "start", "/include/model_common.stan");
    reader.add_event(402, 38, "end", "/include/model_common.stan");
    reader.add_event(402, 91, "restart", "model_poisson");
    reader.add_event(413, 102, "include", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(413, 0, "start", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(419, 6, "end", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(419, 103, "restart", "model_poisson");
    reader.add_event(419, 103, "include", "/include/generated_quantities_common.stan");
    reader.add_event(419, 0, "start", "/include/generated_quantities_common.stan");
    reader.add_event(477, 58, "end", "/include/generated_quantities_common.stan");
    reader.add_event(477, 104, "restart", "model_poisson");
    reader.add_event(477, 104, "include", "/include/generated_quantities_theta.stan");
    reader.add_event(477, 0, "start", "/include/generated_quantities_theta.stan");
    reader.add_event(486, 9, "end", "/include/generated_quantities_theta.stan");
    reader.add_event(486, 105, "restart", "model_poisson");
    reader.add_event(508, 125, "end", "model_poisson");
    return reader;
}
