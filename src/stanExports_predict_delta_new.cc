...
#include "stanExports_predict_delta_new.h"

RCPP_MODULE(stan_fit4predict_delta_new_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_predict_delta_new")
