...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(20, 2, "restart", "model_binomial_1par");
    ...
    reader.add_event(32, 3, "restart", "model_binomial_1par");
    ...
    reader.add_event(106, 6, "restart", "model_binomial_1par");
    reader.add_event(113, 13, "include", "/include/transformed_data_common.stan");
    reader.add_event(113, 0, "start", "/include/transformed_data_common.stan");
    reader.add_event(180, 67, "end", "/include/transformed_data_common.stan");
    reader.add_event(180, 14, "restart", "model_binomial_1par");
    reader.add_event(182, 16, "include", "/include/parameters_common.stan");
    reader.add_event(182, 0, "start", "/include/parameters_common.stan");
    reader.add_event(189, 7, "end", "/include/parameters_common.stan");
    reader.add_event(189, 17, "restart", "model_binomial_1par");
    reader.add_event(191, 19, "include", "/include/transformed_parameters_theta.stan");
    ...
    reader.add_event(196, 20, "restart", "model_binomial_1par");
    reader.add_event(196, 20, "include", "/include/transformed_parameters_common.stan");
    reader.add_event(196, 0, "start", "/include/transformed_parameters_common.stan");
    reader.add_event(306, 110, "end", "/include/transformed_parameters_common.stan");
    reader.add_event(306, 21, "restart", "model_binomial_1par");
    reader.add_event(415, 130, "include", "/include/model_common.stan");
    reader.add_event(415, 0, "start", "/include/model_common.stan");
    reader.add_event(456, 41, "end", "/include/model_common.stan");
    reader.add_event(456, 131, "restart", "model_binomial_1par");
    reader.add_event(469, 144, "include", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(469, 0, "start", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(475, 6, "end", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(475, 145, "restart", "model_binomial_1par");
    reader.add_event(475, 145, "include", "/include/generated_quantities_common.stan");
    reader.add_event(475, 0, "start", "/include/generated_quantities_common.stan");
    reader.add_event(533, 58, "end", "/include/generated_quantities_common.stan");
    reader.add_event(533, 146, "restart", "model_binomial_1par");
    reader.add_event(533, 146, "include", "/include/generated_quantities_theta.stan");
    reader.add_event(533, 0, "start", "/include/generated_quantities_theta.stan");
    reader.add_event(542, 9, "end", "/include/generated_quantities_theta.stan");
    reader.add_event(542, 147, "restart", "model_binomial_1par");
    reader.add_event(564, 167, "end", "model_binomial_1par");
    return reader;
}
...
class model_binomial_1par
  : public stan::model::model_base_crtp<model_binomial_1par> {
private:
        int ns_ipd;
        int ns_agd_arm;
        int ns_agd_contrast;
