...
namespace model_binomial_1par_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_binomial_1par");
    ...
    reader.add_event(18, 2, "restart", "model_binomial_1par");
    ...
    reader.add_event(30, 3, "restart", "model_binomial_1par");
    ...
    reader.add_event(101, 6, "restart", "model_binomial_1par");
    reader.add_event(108, 13, "include", "/include/transformed_data_common.stan");
    reader.add_event(108, 0, "start", "/include/transformed_data_common.stan");
    reader.add_event(175, 67, "end", "/include/transformed_data_common.stan");
    reader.add_event(175, 14, "restart", "model_binomial_1par");
    reader.add_event(177, 16, "include", "/include/parameters_common.stan");
    reader.add_event(177, 0, "start", "/include/parameters_common.stan");
    reader.add_event(184, 7, "end", "/include/parameters_common.stan");
    reader.add_event(184, 17, "restart", "model_binomial_1par");
    reader.add_event(186, 19, "include", "/include/transformed_parameters_common.stan");
    reader.add_event(186, 0, "start", "/include/transformed_parameters_common.stan");
    reader.add_event(288, 102, "end", "/include/transformed_parameters_common.stan");
    reader.add_event(288, 20, "restart", "model_binomial_1par");
    reader.add_event(397, 129, "include", "/include/model_common.stan");
    reader.add_event(397, 0, "start", "/include/model_common.stan");
    reader.add_event(435, 38, "end", "/include/model_common.stan");
    reader.add_event(435, 130, "restart", "model_binomial_1par");
    reader.add_event(448, 143, "include", "/include/generated_quantities_common.stan");
    reader.add_event(448, 0, "start", "/include/generated_quantities_common.stan");
    reader.add_event(512, 64, "end", "/include/generated_quantities_common.stan");
    reader.add_event(512, 144, "restart", "model_binomial_1par");
    reader.add_event(538, 168, "end", "model_binomial_1par");
    return reader;
}
...
class model_binomial_1par : public prob_grad {
private:
        int ns_ipd;
        int ns_agd_arm;
        int ns_agd_contrast;
...
public:
    model_binomial_1par(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_binomial_1par_namespace::model_binomial_1par";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(binomial_log<propto__>(agd_arm_r, agd_arm_n, theta_agd_arm_bar));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_binomial_1par_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int i = 1; i <= ni_agd_arm; ++i) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            binomial_log(get_base1(agd_arm_r, i, "agd_arm_r", 1), get_base1(agd_arm_n, i, "agd_arm_n", 1), get_base1(theta_agd_arm_bar, i, "theta_agd_arm_bar", 1)), 
                            "assigning variable log_lik");
                current_statement_begin__ = 524;
                stan::model::assign(resdev, 
                            stan::model::cons_list(stan::model::index_uni((ni_ipd + i)), stan::model::nil_index_list()), 
                            (2 * (multiply_log(get_base1(agd_arm_r, i, "agd_arm_r", 1), (get_base1(agd_arm_r, i, "agd_arm_r", 1) / (get_base1(agd_arm_n, i, "agd_arm_n", 1) * get_base1(theta_agd_arm_bar, i, "theta_agd_arm_bar", 1)))) + multiply_log((get_base1(agd_arm_n, i, "agd_arm_n", 1) - get_base1(agd_arm_r, i, "agd_arm_r", 1)), ((get_base1(agd_arm_n, i, "agd_arm_n", 1) - get_base1(agd_arm_r, i, "agd_arm_r", 1)) / (get_base1(agd_arm_n, i, "agd_arm_n", 1) - (get_base1(agd_arm_n, i, "agd_arm_n", 1) * get_base1(theta_agd_arm_bar, i, "theta_agd_arm_bar", 1))))))), 
                            "assigning variable resdev");
                current_statement_begin__ = 529;
                stan::model::assign(fitted, 
                            stan::model::cons_list(stan::model::index_uni((ni_ipd + i)), stan::model::nil_index_list()), 
                            (get_base1(agd_arm_n, i, "agd_arm_n", 1) * get_base1(theta_agd_arm_bar, i, "theta_agd_arm_bar", 1)), 
                            "assigning variable fitted");
...
typedef model_binomial_1par_namespace::model_binomial_1par stan_model;
#endif
