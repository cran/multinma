...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(103, 6, "restart", "model_normal");
    reader.add_event(116, 19, "include", "/include/transformed_data_common.stan");
    ...
    reader.add_event(183, 20, "restart", "model_normal");
    reader.add_event(185, 22, "include", "/include/parameters_common.stan");
    reader.add_event(185, 0, "start", "/include/parameters_common.stan");
    reader.add_event(192, 7, "end", "/include/parameters_common.stan");
    reader.add_event(192, 23, "restart", "model_normal");
    reader.add_event(195, 26, "include", "/include/transformed_parameters_theta.stan");
    reader.add_event(195, 0, "start", "/include/transformed_parameters_theta.stan");
    reader.add_event(200, 5, "end", "/include/transformed_parameters_theta.stan");
    reader.add_event(200, 27, "restart", "model_normal");
    reader.add_event(200, 27, "include", "/include/transformed_parameters_common.stan");
    reader.add_event(200, 0, "start", "/include/transformed_parameters_common.stan");
    reader.add_event(302, 102, "end", "/include/transformed_parameters_common.stan");
    reader.add_event(302, 28, "restart", "model_normal");
    reader.add_event(387, 113, "include", "/include/model_common.stan");
    reader.add_event(387, 0, "start", "/include/model_common.stan");
    reader.add_event(425, 38, "end", "/include/model_common.stan");
    reader.add_event(425, 114, "restart", "model_normal");
    reader.add_event(437, 126, "include", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(437, 0, "start", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(443, 6, "end", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(443, 127, "restart", "model_normal");
    reader.add_event(443, 127, "include", "/include/generated_quantities_common.stan");
    reader.add_event(443, 0, "start", "/include/generated_quantities_common.stan");
    reader.add_event(501, 58, "end", "/include/generated_quantities_common.stan");
    reader.add_event(501, 128, "restart", "model_normal");
    reader.add_event(501, 128, "include", "/include/generated_quantities_theta.stan");
    reader.add_event(501, 0, "start", "/include/generated_quantities_theta.stan");
    reader.add_event(510, 9, "end", "/include/generated_quantities_theta.stan");
    reader.add_event(510, 129, "restart", "model_normal");
    reader.add_event(528, 145, "end", "model_normal");
    return reader;
}
