...
class model_binomial_1par final : public model_base_crtp<model_binomial_1par> {
private:
  int ns_ipd;
  int ns_agd_arm;
  int ns_agd_contrast;
...
public:
  ~model_binomial_1par() {}
  model_binomial_1par(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_binomial_1par_namespace::model_binomial_1par";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_binomial_1par_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_binomial_1par_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_binomial_1par_namespace::model_binomial_1par;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_binomial_1par_namespace::profiles__;
}
#endif
#endif
