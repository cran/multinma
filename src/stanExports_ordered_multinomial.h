...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(103, 6, "restart", "model_ordered_multinomial");
    reader.add_event(127, 30, "include", "/include/transformed_data_common.stan");
    reader.add_event(127, 0, "start", "/include/transformed_data_common.stan");
    reader.add_event(194, 67, "end", "/include/transformed_data_common.stan");
    reader.add_event(194, 31, "restart", "model_ordered_multinomial");
    reader.add_event(196, 33, "include", "/include/parameters_common.stan");
    reader.add_event(196, 0, "start", "/include/parameters_common.stan");
    reader.add_event(203, 7, "end", "/include/parameters_common.stan");
    reader.add_event(203, 34, "restart", "model_ordered_multinomial");
    reader.add_event(217, 48, "include", "/include/transformed_parameters_common.stan");
    reader.add_event(217, 0, "start", "/include/transformed_parameters_common.stan");
    reader.add_event(319, 102, "end", "/include/transformed_parameters_common.stan");
    reader.add_event(319, 49, "restart", "model_ordered_multinomial");
    reader.add_event(518, 248, "include", "/include/model_common.stan");
    reader.add_event(518, 0, "start", "/include/model_common.stan");
    reader.add_event(556, 38, "end", "/include/model_common.stan");
    reader.add_event(556, 249, "restart", "model_ordered_multinomial");
    reader.add_event(584, 277, "include", "/include/generated_quantities_common.stan");
    reader.add_event(584, 0, "start", "/include/generated_quantities_common.stan");
    reader.add_event(642, 58, "end", "/include/generated_quantities_common.stan");
    reader.add_event(642, 278, "restart", "model_ordered_multinomial");
    reader.add_event(677, 311, "end", "model_ordered_multinomial");
    return reader;
}
