...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(103, 6, "restart", "model_binomial_1par");
    ...
    reader.add_event(177, 14, "restart", "model_binomial_1par");
    ...
    reader.add_event(186, 17, "restart", "model_binomial_1par");
    reader.add_event(188, 19, "include", "/include/transformed_parameters_theta.stan");
    reader.add_event(188, 0, "start", "/include/transformed_parameters_theta.stan");
    reader.add_event(193, 5, "end", "/include/transformed_parameters_theta.stan");
    reader.add_event(193, 20, "restart", "model_binomial_1par");
    reader.add_event(193, 20, "include", "/include/transformed_parameters_common.stan");
    ...
    reader.add_event(295, 21, "restart", "model_binomial_1par");
    reader.add_event(404, 130, "include", "/include/model_common.stan");
    reader.add_event(404, 0, "start", "/include/model_common.stan");
    reader.add_event(442, 38, "end", "/include/model_common.stan");
    reader.add_event(442, 131, "restart", "model_binomial_1par");
    reader.add_event(455, 144, "include", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(455, 0, "start", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(461, 6, "end", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(461, 145, "restart", "model_binomial_1par");
    reader.add_event(461, 145, "include", "/include/generated_quantities_common.stan");
    reader.add_event(461, 0, "start", "/include/generated_quantities_common.stan");
    reader.add_event(519, 58, "end", "/include/generated_quantities_common.stan");
    reader.add_event(519, 146, "restart", "model_binomial_1par");
    reader.add_event(519, 146, "include", "/include/generated_quantities_theta.stan");
    reader.add_event(519, 0, "start", "/include/generated_quantities_theta.stan");
    reader.add_event(528, 9, "end", "/include/generated_quantities_theta.stan");
    reader.add_event(528, 147, "restart", "model_binomial_1par");
    reader.add_event(550, 167, "end", "model_binomial_1par");
    return reader;
}
