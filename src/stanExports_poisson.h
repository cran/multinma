...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(313, 25, "restart", "model_poisson");
    reader.add_event(378, 90, "include", "/include/model_common.stan");
    reader.add_event(378, 0, "start", "/include/model_common.stan");
    reader.add_event(419, 41, "end", "/include/model_common.stan");
    reader.add_event(419, 91, "restart", "model_poisson");
    reader.add_event(430, 102, "include", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(430, 0, "start", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(436, 6, "end", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(436, 103, "restart", "model_poisson");
    reader.add_event(436, 103, "include", "/include/generated_quantities_common.stan");
    reader.add_event(436, 0, "start", "/include/generated_quantities_common.stan");
    reader.add_event(494, 58, "end", "/include/generated_quantities_common.stan");
    reader.add_event(494, 104, "restart", "model_poisson");
    reader.add_event(494, 104, "include", "/include/generated_quantities_theta.stan");
    reader.add_event(494, 0, "start", "/include/generated_quantities_theta.stan");
    reader.add_event(503, 9, "end", "/include/generated_quantities_theta.stan");
    reader.add_event(503, 105, "restart", "model_poisson");
    reader.add_event(525, 125, "end", "model_poisson");
    return reader;
}
