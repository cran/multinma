...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(20, 2, "restart", "model_normal");
    ...
    reader.add_event(32, 3, "restart", "model_normal");
    ...
    reader.add_event(106, 6, "restart", "model_normal");
    reader.add_event(119, 19, "include", "/include/transformed_data_common.stan");
    reader.add_event(119, 0, "start", "/include/transformed_data_common.stan");
    reader.add_event(186, 67, "end", "/include/transformed_data_common.stan");
    reader.add_event(186, 20, "restart", "model_normal");
    reader.add_event(188, 22, "include", "/include/parameters_common.stan");
    reader.add_event(188, 0, "start", "/include/parameters_common.stan");
    reader.add_event(195, 7, "end", "/include/parameters_common.stan");
    reader.add_event(195, 23, "restart", "model_normal");
    reader.add_event(198, 26, "include", "/include/transformed_parameters_theta.stan");
    reader.add_event(198, 0, "start", "/include/transformed_parameters_theta.stan");
    reader.add_event(203, 5, "end", "/include/transformed_parameters_theta.stan");
    reader.add_event(203, 27, "restart", "model_normal");
    reader.add_event(203, 27, "include", "/include/transformed_parameters_common.stan");
    reader.add_event(203, 0, "start", "/include/transformed_parameters_common.stan");
    reader.add_event(313, 110, "end", "/include/transformed_parameters_common.stan");
    reader.add_event(313, 28, "restart", "model_normal");
    reader.add_event(398, 113, "include", "/include/model_common.stan");
    reader.add_event(398, 0, "start", "/include/model_common.stan");
    reader.add_event(439, 41, "end", "/include/model_common.stan");
    reader.add_event(439, 114, "restart", "model_normal");
    reader.add_event(451, 126, "include", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(451, 0, "start", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(457, 6, "end", "/include/generated_quantities_theta_fitted.stan");
    reader.add_event(457, 127, "restart", "model_normal");
    reader.add_event(457, 127, "include", "/include/generated_quantities_common.stan");
    reader.add_event(457, 0, "start", "/include/generated_quantities_common.stan");
    reader.add_event(515, 58, "end", "/include/generated_quantities_common.stan");
    reader.add_event(515, 128, "restart", "model_normal");
    reader.add_event(515, 128, "include", "/include/generated_quantities_theta.stan");
    reader.add_event(515, 0, "start", "/include/generated_quantities_theta.stan");
    reader.add_event(524, 9, "end", "/include/generated_quantities_theta.stan");
    reader.add_event(524, 129, "restart", "model_normal");
    reader.add_event(542, 145, "end", "model_normal");
    return reader;
}
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            for (int i = 1; i <= ni_ipd; ++i) {
                ...
                stan::model::assign(resdev, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (pow((get_base1(ipd_y, i, "ipd_y", 1) - get_base1(fitted_ipd, i, "fitted_ipd", 1)), 2) / pow(get_base1(sigma, get_base1(ipd_arm, i, "ipd_arm", 1), "sigma", 1), 2)), 
                            "assigning variable resdev");
            }
            ...
            for (int i = 1; i <= ni_agd_arm; ++i) {
                ...
                stan::model::assign(resdev, 
                            stan::model::cons_list(stan::model::index_uni((ni_ipd + i)), stan::model::nil_index_list()), 
                            (pow((get_base1(agd_arm_y, i, "agd_arm_y", 1) - get_base1(fitted_agd_arm, i, "fitted_agd_arm", 1)), 2) / pow(get_base1(agd_arm_se, i, "agd_arm_se", 1), 2)), 
                            "assigning variable resdev");
            }
